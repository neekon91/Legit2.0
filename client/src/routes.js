...
import DashboardMessage from './components/dashboard/messageDashboard/dashboardMessage_component.jsx';
...
import messageForm from './components/forms/messageForm_component.jsx'
...
export default (
    <Router path="/" component={App} >
        ...
        <Route path="message" component={DashboardMessage} />
